...
class Actor(nn.Module):
    ...
    def __init__(self, obs_dim, act_dim, limit, hid_size, activation):
        super().__init__()
        self.model = mlp([obs_dim]+list(hid_size)+[act_dim], activation)
...
class Actor_Critic(nn.Module):
    ...
    def __init__(self, obs_space, act_space, hid_size=(256,256), activation=nn.Tanh):
        super().__init__()
